describe('San Diego Concert Search', () => {
  beforeEach(() => {
  ...
  it('should return Hip-Hop concert results', () => {
    ...
    cy.wait('@ticketmasterApi').then((interception) => {
      ...
      if (responseBody._embedded && responseBody._embedded.events && responseBody._embedded.events.length > 0) {
        ...
        cy.log('No Hip-Hop events found in San Diego for the selected date range');
  ...
  it('should return Rock concert results', () => {
    ...
    cy.wait('@ticketmasterApi').then((interception) => {
      ...
      if (responseBody._embedded && responseBody._embedded.events && responseBody._embedded.events.length > 0) {
        ...
        cy.log('No Rock events found in San Diego for the selected date range');
        expect(responseBody.page.totalElements).to.equal(0);
      }
    });
  ...
  it('should return Country concert results', () => {
    ...
    cy.wait('@ticketmasterApi').then((interception) => {
      ...
      if (responseBody._embedded && responseBody._embedded.events && responseBody._embedded.events.length > 0) {
        ...
        cy.log('No Country events found in San Diego for the selected date range');
        expect(responseBody.page.totalElements).to.equal(0);
      }
    });
  ...
  it('should return Pop concert results', () => {
    ...
    cy.wait('@ticketmasterApi').then((interception) => {
      ...
      if (responseBody._embedded && responseBody._embedded.events && responseBody._embedded.events.length > 0) {
        ...
        cy.log('No Pop events found in San Diego for the selected date range');
        expect(responseBody.page.totalElements).to.equal(0);
      }
    });
  ...
  it('should return Metal concert results', () => {
    ...
    cy.wait('@ticketmasterApi').then((interception) => {
      ...
      if (responseBody._embedded && responseBody._embedded.events && responseBody._embedded.events.length > 0) {
        ...
        cy.log('No Metal events found in San Diego for the selected date range');
        expect(responseBody.page.totalElements).to.equal(0);
      }
    });
